    ...
    return(      
      <>
       <div className="main-nav">
          <Link className="nav" to="home"><b>Home</b></Link> 
          <Link className="nav" to="insert"><b>Insert</b></Link>
          <Link className="nav" to="display"><b>Display</b></Link>
          <Link className="nav" to="update"><b>Update</b></Link>
          <Link className="nav" to="contact"><b>Contact</b></Link>
          <Link className="nav" to="serach"><b>Serach</b></Link>
       </div>
         ...
         {/* <hr size="4" color="red" /> */}
           ...
           <footer class="px-3 pt-4 lg:px-9 border-t-2 bg-blue-200">
